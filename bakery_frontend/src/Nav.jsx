...
//   return (
//     <>
//       <header className="bg-choco text-cream inline-flex items-center w-full px-10 py-2 sticky top-0 z-50">
//         <div>
//           <img src={logo} className="w-45" />
//         </div>
//         <div className="mx-auto">
//           <ul className="flex flex-col-4 gap-8">
//             <li className="transition-transform hover:drop-shadow-[0_0_3px_#FFF3E2]"><Link to="/">Home</Link></li>
//             <li className="relative cursor-pointer">
//               <button
//                 onClick={() => toggleDropdown("menu")}
//                 className="flex items-center gap-1 transition-transform hover:drop-shadow-[0_0_3px_#FFF3E2]"
//               >
//                 Menu
//                 {activeDropdown === "menu" ? (
//                   <CgChevronUp className="mt-1" size={16} />
//                 ) : (
//                   <BiChevronDown className="mt-1" size={16} />
//                 )}
//               </button>
...
//                   </li>
//                   <li className="px-4 py-2 hover:bg-peach">Custom Cakes</li>
//                   <li className="px-4 py-2 hover:bg-peach">Party Orders</li>
...
//               )}
//             </li>
//             <li className="transition-transform hover:drop-shadow-[0_0_3px_#FFF3E2]">Offers</li>
//           </ul>
//         </div>
//         <div>Search</div>
//         <div className="ml-10">
//           <button className="border-cream bg-cream text-choco px-4 py-2 rounded-3xl transition-transform hover:scale-95">
//             Contact
//           </button>
//         </div>
//       </header>
    ...
    <div>
      ...
      <header className="bg-choco text-cream flex items-center justify-between w-full px-6 py-3 fixed top-0 z-50">
        ...
        <nav className="hidden md:flex items-center gap-8">
          <ul className="flex gap-8">
            ...
            <li className={isActive("/services") ? "text-caramel font-bold" : "hover:drop-shadow-[0_0_3px_#FFF3E2]"}>
              <Link to="/services">Services</Link>
            </li>
            {/* </li> */}

            <li className="hover:drop-shadow-[0_0_3px_#FFF3E2]"><Link to="/offers">Offers</Link> <span className="badge border border-mint bg-mint rounded-2xl p-1 text-[10px] font-medium text-green-900 ">Coming soon</span></li>
          </ul>
        </nav>
      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-choco text-cream flex flex-col px-6 py-4 gap-4 relative">
          ...
          <Link to="/services" className={isActive("/services") ? "text-caramel font-bold" : "hover:text-peach"}>
            Services
          </Link>
          {/* <button
            onClick={() => toggleDropdown("services")}
          ...
          <Link to="/offers" className="hover:text-peach">
            Offers
          </Link>

          {/* <button className="border-cream bg-cream text-choco px-4 py-2 rounded-3xl hover:scale-95 transition">
            Contact
          </button> */}
