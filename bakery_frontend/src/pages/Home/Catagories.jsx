...
// const categoryItems = [
//     {id:1, title:"Signature Sweets", description1:"(Indian & Fusion Delights)", description2:"45+ dishes", image:img},
//     {id:2, title:"Savory Bites", description1:"(Crispy, Spicy & Flavorful Snacks)", description2:"50+ dishes", image:img1},
//     {id:3, title:"Cakes & Pastries", description1:"(Custom-made for all occasion)", description2:"100+ dishes", image:img},
//     {id:4, title:"Browse All", description1:"(Explore sweet & savory delights)", description2:"250+ dishes", image:img}
// ]

// const Catagories = () => {
//   return (
//     <div className='flex flex-col sm:flex-row flex-wrap gap-8 justify-around items-center mt-15'>
//       {
...
//                     <img src={item.image} alt="item" className='bg-peach p-5 rounded-full h-50 w-50'/>
//                 </div>
//                 <div className='mt-5 space-y-1'>
//                     <h1 className='text-choco text-xl font-bold'>{item.title}</h1>
//                     <p className='text-caramel font-medium'>{item.description1}</p>
//                     <p className='text-gray-500 font-medium'>{item.description2}</p>
//                 </div>
//             </div>
//         ))
//       }
