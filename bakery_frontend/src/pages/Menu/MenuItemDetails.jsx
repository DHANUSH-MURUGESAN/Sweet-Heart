...
//   };
  ...
  //         if (!prevList.some((i) => i._id === item._id)) return [...prevList, item];
  //         return prevList;
  //       });
  //       sound.play();
  //     } else if (item) {
        ...
        <section className="relative flex flex-col md:flex-row gap-10 bg-cream">
          ...
          <div className="flex-1 space-y-3 mt-10 mx-10">
            ...
            <button
              ...
              className="bg-choco text-white px-6 py-3 rounded-3xl font-semibold hover:bg-caramel transition duration-300"
            >
              Add to Cart
            </button>
          </div>
